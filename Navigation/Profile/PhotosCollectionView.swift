...
////        self.photoCollectionView.register(PhotosCollectionViewCell.self, forCellWithReuseIdentifier: PhotosCollectionViewCell.identifire)
////        self.photoCollectionView.contentInset = UIEdgeInsets(top: 8, left: 8, bottom: 8, right: 8)

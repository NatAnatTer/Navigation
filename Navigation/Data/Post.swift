...
let postOne = Post(author: "Asynchronously Loading Images into Table and Collection Views", descriptionOfPost: "Сложнее всего начать действовать, все остальное зависит только от упорства.", imageOfPost: "postOne", likes: 400, views: 100, isShortDecription: true)
